...
To run the program, clone the repository to your device, and using CMake and CMakeLists.txt, compile and run the program. (Developers used Clion's 'CMake Application' Run Configuration.)
<img width="835" height="710" alt="image" src="https://github.com/user-attachments/assets/4b7556ba-7c42-4c4e-bf26-facd7d2cef9a" />

Alternatively, if you need to run the program in the console, after cloning the repository, run the following commands in cmd.
